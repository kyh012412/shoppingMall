  ...
  const loadProduct = async () => {
    ...
    if (detail) {
      getProduct = await fetch(
        `${process.env.REACT_APP_SERVER}/product?detail=${detail}&offset=${offset}&limit=${limit}`
      ).then((res) => res.json());
    } else if (category) {
      getProduct = await fetch(
        `${process.env.REACT_APP_SERVER}/product?category=${category}&offset=${offset}&limit=${limit}`
      ).then((res) => res.json());
    } else {
      getProduct = await fetch(
        `${process.env.REACT_APP_SERVER}/product?offset=${offset}&limit=${limit}`
      ).then((res) => res.json());
    }
